    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        ...
        >
          ...
          {/* Menu Items */}
          {['admin', 'super_admin', 'moderator', 'editor'].includes(user?.role || '') && (
            <Link
              to="/admin"
              onClick={handleMenuClick}
              className="flex items-center gap-3 px-4 py-2.5 text-sm text-secondary-2 hover:bg-red-50 transition-colors font-medium"
              role="menuitem"
            >

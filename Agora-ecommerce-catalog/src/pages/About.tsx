        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-[75px] items-center mb-20 md:mb-[140px]">
          <div className="order-2 lg:order-1">
            ...
            <p className="text-base text-text-2 leading-relaxed">
              Exclusive has more than 1 Million products to offer, growing at a very fast rate. Exclusive offers a diverse assortment in categories ranging from consumer electronics to fashion and lifestyle.
            </p>
          </div>
